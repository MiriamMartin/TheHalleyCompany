...
public class TerminalHandler : MonoBehaviour
{
    ...
    public Material TermNormal;
    public Material TermHallucinate;
    ...
    public IEnumerator BootSeq()
    {
        ...
        isTerminalOn = true;
        whirringAudio.Play();
        if (firstBoot || Random.Range(1, 5) == 1)
        {
            firstBoot = false;
            StartCoroutine(HallucinateTerminal());
        }
    }
    ...
    public IEnumerator HallucinateTerminal()
    {
        Material[] currentMaterials = ScreenMesh.materials;
        currentMaterials[1] = TermHallucinate;
        ScreenMesh.materials = currentMaterials;

        yield return new WaitForSeconds(2);

        currentMaterials[1] = TermNormal;
        ScreenMesh.materials = currentMaterials;
    }
